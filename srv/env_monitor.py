...
class EnvMonitor:
    def __init__(self):
        ...
        #map setting
        self.localmap_shape=np.array((30,30))         #map size 30 width 30 length
        ...
        self.people_pub_1=rospy.Publisher('/actor4/reset_command', Float32MultiArray, queue_size=1)
        self.people_pub_2=rospy.Publisher('/actor5/reset_command', Float32MultiArray, queue_size=1)
        self.people_pub_3=rospy.Publisher('/actor6/reset_command', Float32MultiArray, queue_size=1)
    ...
    def obst_map_cb(self,data):
        ...
        matrix = np.array(data.data).reshape(30, 30)
    ...
    def people_cb(self,data):
        ...
        for item in data.people:
            ...
            if np.linalg.norm(pos_vec-pos_viechle_current)>30:
                continue
    ...
    def gazebo_reset(self):
        ...
        people_pos=self.generate_arrays(3)
    ...
    def generate_car(self):
        point_set=np.array([[2.4,5.4],[-3,4],[-3.3,-9],[2.5,-9]])
        
        possible_case=np.array([[0,2],[0,3],[1,2],[1,3],[2,0],[3,0],[3,1],[2,1]])
